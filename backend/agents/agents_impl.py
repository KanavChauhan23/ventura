...
Return ONLY valid JSON."""
    ...
    def _parse_output(self, raw: str) -> dict:
        return {
            ...
            "tech_stack_ai": "LangChain + OpenAI",
            ...
            "design_system": "Orange #FF6803 primary, dark #0B0501 background",
            "deployment_strategy": "Docker + AWS ECS + CloudFront",
            "integrations": "Stripe, OpenAI, SendGrid, Slack",
        }
...

{
  ...
  "launch_strategy": "Product launch strategy (100 words max)",
...
Return ONLY valid JSON."""
    ...
    def _parse_output(self, raw: str) -> dict:
        return {
            ...
            "email_subject_lines": "Your startup idea → live in 24 hours 🚀",
...

{
  ...
  "email_sequence_body_1": "Cold email body day 1 (50 words)",
  "email_sequence_subject_2": "Follow-up subject line day 3",
  "email_sequence_body_2": "Follow-up body day 3 (30 words)",
  "linkedin_message": "LinkedIn connection message (50 words)",
  "sales_pitch": "60-second elevator pitch",
  "objection_handling": "Top 3 objections + responses, comma-separated",
  ...
  "expected_conversion_rate": "Expected lead-to-customer conversion %",
  "average_deal_size": "Expected average deal/subscription value",
...
Return ONLY valid JSON."""
    ...
    def _parse_output(self, raw: str) -> dict:
        return {
            ...
            "email_sequence_body_1": "Hey {name}, I saw you're building in the {space} space. We help founders launch their entire company with AI in minutes. Worth a 15-min call?",
            "email_sequence_subject_2": "Following up — Ventura AI",
            "email_sequence_body_2": "Just wanted to bump this up. Founders using us are launching 10x faster. Let me know if you'd like to see a demo.",
            "linkedin_message": "Hey {name}! Love what you're building. We help founders like you automate the whole company-building process with AI. Happy to share how!",
            "sales_pitch": "Ventura AI is the only platform that builds your entire company — market research, product, marketing, and sales — using autonomous AI agents. You describe the idea, we do the rest.",
